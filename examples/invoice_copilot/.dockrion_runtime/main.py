...
if __name__ == "__main__":
    ...
    print(f"🚀 Starting invoice-service on {host}:{port}")
    uvicorn.run(
        app,
        host=host,
        port=port,
