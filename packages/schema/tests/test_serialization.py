...
def full_spec_data():
    ...
    return {
        ...
        "policies": {
            "tools": {"allowed": ["extract_invoice"], "deny_by_default": True},
            "safety": {"redact_patterns": [r"\b\d{16}\b"], "max_output_chars": 5000},
        },
        "auth": {"mode": "api_key", "rate_limits": {"admin": "1000/m"}},
        "expose": {"rest": True, "streaming": "sse", "port": 8080, "host": "0.0.0.0"},
        "metadata": {
...
class TestSerializationEdgeCases:
    ...
    def test_unicode_in_fields(self):
        ...
        data = {
            ...
            "io_schema": {},
            "expose": {"port": 8080},
            "metadata": {"maintainer": "alice@example.com"},
        }
