"""
AgentDock Shared Constants

This module defines constants used across multiple AgentDock packages and services.
...
"""Current AgentDock platform version"""
...
"""Agent frameworks supported by AgentDock"""
...
"""LLM providers supported by AgentDock"""

SUPPORTED_AUTH_MODES = ["jwt", "api_key", "oauth2"]
"""Authentication modes supported by AgentDock"""
...
ENV_API_KEY = "AGENTDOCK_API_KEY"
"""Environment variable for AgentDock API key"""

ENV_CONTROLLER_URL = "AGENTDOCK_CONTROLLER_URL"
"""Environment variable for Controller service URL"""

ENV_AUTH_URL = "AGENTDOCK_AUTH_URL"
"""Environment variable for Auth service URL"""

ENV_BUILDER_URL = "AGENTDOCK_BUILDER_URL"
